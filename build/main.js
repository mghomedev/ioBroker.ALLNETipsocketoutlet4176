...
class Allnetipsocketoutlet4176 extends utils.Adapter {
    ...
    async createAllAdapterStatesFromCurrentAllNetObject() {
        ...
        this.log.info("createAllAdapterStatesFromCurrentAllNetObject for ALLNETadapter=" +
            adapterPrefix);
        await this.createState("", "", "device_name", {
            name: "device_name",
            def: "",
            type: "string",
            read: true,
        ...
        await this.createState("", "", "device_date", {
            name: "device_date",
            def: "",
            type: "string",
            read: true,
        ...
        await this.createState("", "", "device_uptime", {
            name: "device_uptime",
            def: "",
            type: "string",
            read: true,
        ...
        await this.createState("", "", "firmware", {
            name: "firmware",
            def: "",
            type: "string",
            read: true,
        ...
        await this.createState("", "", "hardware_model", {
            name: "hardware_model",
            def: "",
            type: "string",
            read: true,
        ...
        await this.createState("", "", "hardware_revision", {
        ...
        await this.createState("", "", "triggerForceRefresh", {
        ...
        for (var aiter of allnet.actors) {
            ...
            if (a.id == null || a.id.length == 0)
                continue;
            await this.createState("", "actors", "actor_" + a.id + "_id", {
            ...
            await this.createState("", "actors", "actor_" + a.id + "_name", {
            ...
            await this.createState("", "actors", "actor_" + a.id + "_state", "state", {
        ...
        for (var siter of allnet.sensors) {
            ...
            if (s.id == null || s.id.length == 0)
                continue;
            await this.createState("", "sensors", "sensor_" + s.id + "_id", {
            ...
            await this.createState("", "sensors", "sensor_" + s.id + "_name", {
            ...
            await this.createState("", "sensors", "sensor_" + s.id + "_value", "value", {
            ...
            await this.createState("", "sensors", "sensor_" + s.id + "_unit", "unit", {
    ...
    async refreshAllAdapterStatesFromCurrentAllNetObject() {
        var allnet = this._allnet;
